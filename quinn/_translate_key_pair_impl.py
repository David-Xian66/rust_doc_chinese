"""Translate 3 untranslated docblocks in quinn/crypto/struct.KeyPair.html."""

import re

PATH = 'D:/Administrator/Documents/Code/rust_doc_all/quinn/crypto/struct.KeyPair.html'

TRANSLATIONS = [
    ('<p>Key for encrypting data</p>',
     '<p>用于加密数据的密钥</p>'),
