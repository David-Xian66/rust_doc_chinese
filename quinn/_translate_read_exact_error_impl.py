"""Translate 3 untranslated docblocks in quinn/enum.ReadExactError.html."""

import re

PATH = 'D:/Administrator/Documents/Code/rust_doc_all/quinn/enum.ReadExactError.html'

TRANSLATIONS = [
    ('<p>The stream finished before all bytes were read</p>',
     '<p>流在所有字节被读取完毕前已结束</p>'),
