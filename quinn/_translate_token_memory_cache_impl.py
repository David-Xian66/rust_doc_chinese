"""Translate 3 untranslated docblocks in quinn/struct.TokenMemoryCache.html."""

import re

PATH = 'D:/Administrator/Documents/Code/rust_doc_all/quinn/struct.TokenMemoryCache.html'

TRANSLATIONS = [
    ('<p>Defaults to a maximum of 256 servers and 2 tokens per server</p>',
     '<p>默认为每个服务器最多 256 个服务器以及 2 个令牌</p>'),
