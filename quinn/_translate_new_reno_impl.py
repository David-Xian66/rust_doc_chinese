"""Translate 3 untranslated docblocks in quinn/congestion/struct.NewReno.html."""

import re

PATH = 'D:/Administrator/Documents/Code/rust_doc_all/quinn/congestion/struct.NewReno.html'

TRANSLATIONS = [
    ('<p>Construct a state using the given <code>config</code> and current time <code>now</code></p>',
     '<p>使用给定的 <code>config</code> 与当前时间 <code>now</code> 构造一份状态</p>'),
