"""Translate 5 untranslated docblocks in quinn/enum.Side.html."""

import re

PATH = 'D:/Administrator/Documents/Code/rust_doc_all/quinn/enum.Side.html'

TRANSLATIONS = [
    ('<p>The initiator of a connection</p>',
     '<p>连接的发起方</p>'),
    ('<p>The acceptor of a connection</p>',
     '<p>连接的接受方</p>'),
    ('<p>Shorthand for <code>self == Side::Client</code></p>',
     '<p>等价于 <code>self == Side::Client</code></p>'),
