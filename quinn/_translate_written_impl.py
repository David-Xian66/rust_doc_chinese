"""Translate 4 untranslated docblocks in quinn/struct.Written.html."""

import re

PATH = 'D:/Administrator/Documents/Code/rust_doc_all/quinn/struct.Written.html'

TRANSLATIONS = [
    ('<p>The amount of bytes which had been written</p>',
     '<p>已写入的字节数</p>'),
    ('<p>The amount of full chunks which had been written</p>\n<p>If a chunk was only partially written, it will not be counted by this field.</p>',
     '<p>已写入的完整数据块数量</p>\n<p>如果某个数据块仅被部分写入，则不会被该字段计入。</p>'),
