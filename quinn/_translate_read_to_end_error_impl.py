"""Translate 4 untranslated docblocks in quinn/enum.ReadToEndError.html."""

import re

PATH = 'D:/Administrator/Documents/Code/rust_doc_all/quinn/enum.ReadToEndError.html'

TRANSLATIONS = [
    ('<p>An error occurred during reading</p>',
     '<p>读取过程中发生错误</p>'),
    ('<p>The stream is larger than the user-supplied limit</p>',
     '<p>该流大于用户提供的上限</p>'),
