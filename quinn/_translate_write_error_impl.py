"""Translate 6 untranslated docblocks in quinn/enum.WriteError.html."""

import re

PATH = 'D:/Administrator/Documents/Code/rust_doc_all/quinn/enum.WriteError.html'

TRANSLATIONS = [
    ('<p>The peer is no longer accepting data on this stream</p>\n<p>Carries an application-defined error code.</p>',
     '<p>对端已不再接受该流上的数据</p>\n<p>携带一个由应用层定义的错误码。</p>'),
    ('<p>The connection was lost</p>',
     '<p>连接已丢失</p>'),
    ('<p>The stream has already been finished or reset</p>',
     '<p>该流已经被 finish 或 reset</p>'),
