"""Translate 5 untranslated docblocks in quinn/congestion/struct.ControllerMetrics.html."""

import re

PATH = 'D:/Administrator/Documents/Code/rust_doc_all/quinn/congestion/struct.ControllerMetrics.html'
...
TRANSLATIONS = [
    ...
    ('<p>Congestion window (bytes)</p>',
     '<p>拥塞窗口（字节）</p>'),
    ('<p>Slow start threshold (bytes)</p>',
     '<p>慢启动阈值（字节）</p>'),
