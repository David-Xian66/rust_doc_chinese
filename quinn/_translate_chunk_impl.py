"""Translate 4 untranslated docblocks in quinn/struct.Chunk.html."""

import re

PATH = 'D:/Administrator/Documents/Code/rust_doc_all/quinn/struct.Chunk.html'

TRANSLATIONS = [
    ('<p>The offset in the stream</p>',
     '<p>在流中的偏移量</p>'),
    ('<p>The contents of the chunk</p>',
     '<p>该数据块的内容</p>'),
