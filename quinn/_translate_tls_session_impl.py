"""Translate 3 untranslated docblocks in quinn/crypto/rustls/struct.TlsSession.html."""

import re

PATH = 'D:/Administrator/Documents/Code/rust_doc_all/quinn/crypto/rustls/struct.TlsSession.html'

TRANSLATIONS = [
    ('<p>For the rustls <code>TlsSession</code>, the <code>Any</code> type is <code>Vec&lt;rustls::pki_types::CertificateDer&gt;</code></p>',
     '<p>对于 rustls <code>TlsSession</code>，<code>Any</code> 类型为 <code>Vec&lt;rustls::pki_types::CertificateDer&gt;</code></p>'),
