"""Translate 4 untranslated docblocks in quinn/enum.Dir.html."""

import re

PATH = 'D:/Administrator/Documents/Code/rust_doc_all/quinn/enum.Dir.html'

TRANSLATIONS = [
    ('<p>Data flows in both directions</p>',
     '<p>数据可双向流动</p>'),
    ('<p>Data flows only from the stream’s initiator</p>',
     '<p>数据仅从该流的发起方流向对端</p>'),
