"""Translate 3 untranslated docblocks in quinn/crypto/struct.Keys.html."""

import re

PATH = 'D:/Administrator/Documents/Code/rust_doc_all/quinn/crypto/struct.Keys.html'

TRANSLATIONS = [
    ('<p>Header protection keys</p>',
     '<p>包头保护密钥</p>'),
